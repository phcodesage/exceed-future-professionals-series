"use strict";(()=>{var e={};e.id=832,e.ids=[832],e.modules={145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},6326:e=>{e.exports=import("resend")},6249:(e,t)=>{Object.defineProperty(t,"l",{enumerable:!0,get:function(){return function e(t,r){return r in t?t[r]:"then"in t&&"function"==typeof t.then?t.then(t=>e(t,r)):"function"==typeof t&&"default"===r?t:void 0}}})},4992:(e,t,r)=>{r.a(e,async(e,i)=>{try{r.r(t),r.d(t,{config:()=>p,default:()=>l,routeModule:()=>c});var n=r(1802),o=r(7153),s=r(6249),a=r(7242),d=e([a]);a=(d.then?(await d)():d)[0];let l=(0,s.l)(a,"default"),p=(0,s.l)(a,"config"),c=new n.PagesAPIRouteModule({definition:{kind:o.x.PAGES_API,page:"/api/experience-registration",pathname:"/api/experience-registration",bundlePath:"",filename:""},userland:a});i()}catch(e){i(e)}})},1443:(e,t,r)=>{r.d(t,{l7:()=>p,XA:()=>g,h9:()=>d,uD:()=>s});let i=require("mongoose");var n=r.n(i);let o=global.mongoose??(global.mongoose={conn:null,promise:null});async function s(){let e=process.env.MONGODB_URI||"";if(!e)throw Error("MONGODB_URI environment variable is not set");if(o.conn)return o.conn;o.promise||(o.promise=n().connect(e,{bufferCommands:!1}));try{o.conn=await o.promise}catch(e){throw o.promise=null,e}return o.conn}let a=new(n()).Schema({parentName:{type:String,required:!0},childName:{type:String,required:!0},email:{type:String,required:!0},phone:{type:String,required:!0},gradeLevel:{type:String,required:!0},programInterests:{type:[String],default:[]},interests:{type:String}},{timestamps:!0}),d=n().models.WaitlistEntry||n().model("WaitlistEntry",a),l=new(n()).Schema({fullName:{type:String,required:!0},emailOrContact:{type:String,required:!0},selectedDate:{type:String,required:!0},selectedTime:{type:String,required:!0}},{timestamps:!0}),p=n().models.ExperienceRegistration||n().model("ExperienceRegistration",l),c=new(n()).Schema({sessionId:{type:String,required:!0,index:!0},page:{type:String,required:!0},referrer:{type:String,default:""},userAgent:{type:String,default:""},lastActive:{type:Date,default:Date.now,index:!0}},{timestamps:!0}),g=n().models.PageVisit||n().model("PageVisit",c)},7242:(e,t,r)=>{r.a(e,async(e,i)=>{try{r.r(t),r.d(t,{default:()=>a});var n=r(6326),o=r(1443),s=e([n]);n=(s.then?(await s)():s)[0];let d=process.env.RESEND_API_KEY,l=d?new n.Resend(d):null,p=["info@exceedlearningcenterny.com","olganyc21@gmail.com","phcodesage@gmail.com"];async function a(e,t){if("POST"!==e.method)return t.status(405).json({message:"Method not allowed"});try{let{fullName:r,emailOrContact:i,selectedDate:n,selectedTime:s}=e.body;if(!r||!i||!n||!s)return t.status(400).json({message:"Missing required fields."});await (0,o.uD)();let a=new o.l7({fullName:r,emailOrContact:i,selectedDate:n,selectedTime:s});if(await a.save(),l)try{await l.emails.send({from:"Exceed Future Professionals <noreply@swe-rech.site>",to:p,subject:`🎉 New Experience Day Registration - ${n}`,html:`
