...
export const programs = [
    ...
    },
    {
        ...
        name: 'Future Artist',
        icon: Palette,
        startDate: 'April 28, 2027',
        startDates: ['April 28, 2027', 'October 26, 2027'],
        hasSyllabus: true,
        videos: [],
        content: [
            {
                ...
                syllabus: [
                    ...
                    { week: 'Week 8', title: 'Art Show and Future Artist Graduation', desc: 'Creating artwork' },
                ],
            },
        ],
    },
    ...
    },
    {
        ...
        name: 'Future Lawyer',
        icon: Scale,
        startDate: 'September 3, 2026',
        startDates: ['September 3, 2026', 'April 29, 2027'],
        hasSyllabus: true,
        videos: [],
        content: [
            {
    ...
    },
    {
        ...
        name: 'Future Vet',
        icon: PawPrint,
        startDate: 'November 3, 2027',
        startDates: ['November 3, 2027'],
        hasSyllabus: false,
        videos: [],
    },
    {
    ...
    },
    {
        ...
        icon: FlaskConical,
        startDate: 'January 6, 2027',
        startDates: ['January 6, 2027'],
        hasSyllabus: false,
        videos: [],
    },
];
